...
function checkFormRequirements() {
    ...
    if(projectTitle.value == "" || projectDescription.value == "" || projectDueDate.value == "") { 
        ...
        if(projectTitle.value == ""){
            ...
            setTimeout(function(){ projectTitle.style.boxShadow = "none"; }, 2000);
        }
        if(projectDescription.value == ""){
            projectDescription.style.boxShadow = "0px 0px 2px 2px rgb(171, 0, 0)";
            setTimeout(function(){ projectDescription.style.boxShadow = "none"; }, 2000);
        }
        if(projectDueDate.value == ""){
            projectDueDate.style.boxShadow = "0px 0px 2px 2px rgb(171, 0, 0)";
            setTimeout(function(){ projectDueDate.style.boxShadow = "none"; }, 2000);
        }
